...
- **run_hbi_model_learning_combined_block**: computational model of learning (2nd stage: hierarchial fitting across all the participants based on 1st stage estimation)
- **run_lap_model_happiness_rating_combined_block**: computational model of happiness (1st stage: running on each participant)
- **run_hbi_model_happiness_rating_combined_block**: computational model of happiness (2nd stage: hierarchial fitting across all the participants based on 1st stage estimation)
