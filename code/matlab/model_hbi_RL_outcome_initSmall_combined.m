function [LL, model_var] = model_hbi_RL_outcome_initSmall_combined(param, data, idx_free, param_default, isSim)
...
for b = 1:nBlock
    ...
    for t = 1:nTrial_total
        ...
        if sum(trial_subject_choice(t,:))==0
            break
        end
